...
const ProjectDetails = ({ project }) => {
    return (
        <div className="col-lg-6 col-md-12 col-sm-12">
            ...
            <Zoom >
                <div className="card card-design m-4 text-center" style={{ border: " 2px solid rgba(14, 165, 202, 0.267)",borderRadius:'10px' }}>
                    <div className=" p-3" style={{ backgroundColor: "#008080" }}>
                        ...
                        <div className="card-body">
                            ...
                            <a href={project.codeURLClient} className="btn mx-2 link-button-design" target='_blank' rel="noopener noreferrer" style={{ textDecoration: "none", color: "white", border: "2px solid #f9ab00" }} >  Github(Client)</a>
                            <a href={project.codeURLServer} className="btn mx-2 link-button-design" target='_blank' rel="noopener noreferrer" style={{ textDecoration: "none", color: "white", border: "2px solid #f9ab00" }} >  Github(server)</a>
